...
/**
 * @ClassName org.apache.shenyu.plugin.sureness.SurenessPlugin
 * Description TODO
 * @Author hqgor
 * @Date 2021/9/2915:35
 * @Version 1.0
 */
@Component
public class SurenessPlugin extends AbstractShenyuPlugin {
    private static final Logger logger = LoggerFactory.getLogger(SurenessPlugin.class);
    ...
    protected Mono<Void> doExecute(ServerWebExchange exchange, ShenyuPluginChain chain, SelectorData selector, RuleData rule) {
        ...
        return chain.execute(exchange).doFinally(x -> SurenessContextHolder.unbindSubject());
